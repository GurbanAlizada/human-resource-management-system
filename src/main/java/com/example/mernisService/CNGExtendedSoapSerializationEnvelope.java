...
public class CNGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CNGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CNGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CNGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CNGDateTimeConverter dateTimeConverter = new CNGStandardDateTimeConverter();

    public CNGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CNGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CNGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CNGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CNGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CNGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
