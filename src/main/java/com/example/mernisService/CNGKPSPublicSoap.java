...
public class CNGKPSPublicSoap
{
    ...
    public CNGKPSPublicSoap(){}

    public CNGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CNGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CNGExtendedSoapSerializationEnvelope envelope= new CNGExtendedSoapSerializationEnvelope(CNGExtendedSoapSerializationEnvelope.VER11);
